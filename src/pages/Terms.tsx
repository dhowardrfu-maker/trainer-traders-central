      ...
      <main className="container py-8 max-w-3xl">
        ...
        <section className="prose prose-sm max-w-none space-y-8 text-foreground">
          ...
          <div>
            ...
            <h3 className="font-semibold mt-3 mb-1">5.3 Prohibited Items</h3>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div>
            ...
            <p>All purchases are final once payment is confirmed, subject to our returns policy below. By completing a purchase, you enter into a contract with the seller, not with PrelovedKicks. PrelovedKicks acts as an intermediary platform only.</p>
          ...
          <div>
            <h2 className="font-bold text-xl mb-2">8. Returns and Refunds</h2>
            <h3 className="font-semibold mt-3 mb-1">8.1 Item Not as Described</h3>
            <p>If an item arrives significantly not as described, you may be eligible for a refund. You must contact support@prelovedkicks.co.uk within 48 hours of receiving the item and provide photographic evidence.</p>
            <h3 className="font-semibold mt-3 mb-1">8.2 Change of Mind</h3>
            <p>We do not offer refunds for change of mind purchases. All sales are final unless the item is not as described.</p>
            <h3 className="font-semibold mt-3 mb-1">8.3 Counterfeit Items</h3>
            <p>If you receive an item you believe to be counterfeit, contact us immediately at support@prelovedkicks.co.uk.</p>
          </div>

          <div>
            <h2 className="font-bold text-xl mb-2">9. Offers and Negotiations</h2>
          ...
          <div>
            <h2 className="font-bold text-xl mb-2">10. Reviews and Ratings</h2>
          ...
          <div>
            <h2 className="font-bold text-xl mb-2">11. Prohibited Conduct</h2>
            <ul className="list-disc pl-5 space-y-1">
          ...
          <div>
            <h2 className="font-bold text-xl mb-2">12. Limitation of Liability</h2>
          ...
          <div>
            <h2 className="font-bold text-xl mb-2">13. Governing Law</h2>
            <p>These terms are governed by the laws of England and Wales. Any disputes shall be subject to the exclusive jurisdiction of the courts of England and Wales.</p>
          </div>

          <div>
            <h2 className="font-bold text-xl mb-2">14. Consumer Rights</h2>
          ...
          <div>
            <h2 className="font-bold text-xl mb-2">15. Contact Us</h2>
