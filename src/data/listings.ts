...
export const SAMPLE_LISTINGS: Listing[] = [
  ...
  { id: "s2", title: "Samba OG Black", brand: "adidas", sizeUk: 8, condition: "Like new", gender: "unisex", color: "Black", description: "Classic Samba OG, worn twice indoors only.", price: 75, image: trainer2, images: [trainer2], seller: { name: "kicks_jay", rating: 5.0 }, postedAgo: "5h", isSample: true },
